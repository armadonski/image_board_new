...
Encore
    ...
    .addStyleEntry('DrawerToggle','./assets/image_board/components/UI/DrawerToggle/DrawerToggle.css')
    ...
    .addStyleEntry('SideDrawer','./assets/image_board/components/Navigation/Toolbar/SideDrawer/SideDrawer.css')
    .addStyleEntry('Menu','./assets/image_board/components/Navigation/Toolbar/SideDrawer/Menu/Menu.css')
